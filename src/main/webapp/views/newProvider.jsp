...
<head>
    ...
    <title>Thêm nhà cung cấp mới - WMS</title>
...
<div class="container mt-4">
    <div class="form-header">
        <h2><i class="fas fa-truck"></i> Thêm nhà cung cấp mới</h2>
        <p class="mb-0">Điền thông tin nhà cung cấp vào form bên dưới</p>
    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="providerName" name="providerName" class="form-control" required maxlength="100" 
                               value="${param.providerName}" placeholder="Nhập tên nhà cung cấp">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" required maxlength="255" 
                               value="${param.email}" placeholder="Nhập email nhà cung cấp">
                    </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <textarea id="address" name="address" class="form-control" required rows="3" maxlength="500" 
                          placeholder="Nhập địa chỉ nhà cung cấp">${param.address}</textarea>
            </div>
