...
<head>
    ...
    <title>Chỉnh sửa điều kiện bán hàng - WMS</title>
    ...
    <div class="container-fluid">
        ...
        <div class="page-header text-center">
            <div class="container">
                <h1 class="display-5 fw-bold mb-0">
                    <i class="fas fa-edit me-3"></i>Chỉnh sửa Điều kiện Bán hàng
                </h1>
                <p class="lead mb-0">Cập nhật thông tin điều kiện bán hàng</p>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <!-- Info Card -->
                <div class="info-card">
                    <h6 class="mb-2"><i class="fas fa-info-circle me-2"></i>Thông tin điều kiện</h6>
                    <div class="row">
                        <div class="col-sm-6">
                            <strong>ID:</strong> ${saleCondition.saleConditionId}
                        </div>
                        <div class="col-sm-6">
                            <strong>Người tạo:</strong> ${saleCondition.createdBy}
                        </div>                        <div class="col-sm-6">
                            <strong>Ngày tạo:</strong> 
                            ${saleCondition.createdDate.toString().replace('T', ' ')}
                        </div>
                        <div class="col-sm-6">
                            <strong>Trạng thái:</strong>
                            <c:choose>
                                <c:when test="${saleCondition.active}">
                ...
                <div class="form-card">
                    <form method="post" action="${pageContext.request.contextPath}/sale-conditions" id="saleConditionForm">
                        ...
                        <input type="hidden" name="id" value="${saleCondition.saleConditionId}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="conditionCode" name="conditionCode" 
                                   value="${saleCondition.conditionCode}" maxlength="50" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="type" name="type" required onchange="updateAmountLabel()">
                                ...
                                <option value="percentage" ${saleCondition.type == 'percentage' || saleCondition.type == '%' ? 'selected' : ''}>Phần trăm (%)</option>
                                <option value="fixed" ${saleCondition.type == 'fixed' ? 'selected' : ''}>Số tiền cố định (₫)</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="amount" name="amount" 
                                       value="${saleCondition.amount}" step="0.01" min="0.01" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="effectiveDate" name="effectiveDate" 
                                   value="${saleCondition.effectiveDate.toString().substring(0, 16)}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="expiredDate" name="expiredDate" 
                                   value="<c:if test='${saleCondition.expiredDate != null}'>${saleCondition.expiredDate.toString().substring(0, 16)}</c:if>">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Cập nhật điều kiện
                            </button>
                        </div>
                    </form>
                </div>
